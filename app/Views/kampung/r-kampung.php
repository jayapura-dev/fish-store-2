...
<div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <span class="text-uppercase page-subtitle">Kampung</span>
        <hr />
    </div>
</div>
            ...
            <div class="card-body p-0 pb-3">
                <div class="container">
                    ...
                    <table class="table mb-0 table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($kampung as $item): 
                                $no = 1;    
                            ?>
                            <tr class="small">
                                <td><?php echo $no++ ?></td>
                                <td><strong> <?php echo $item->kode_prov ?> . <?php echo $item->kode_kab ?> . <?php echo $item->kode_dis ?> . <?php echo $item->kode_kampung ?></strong></td>
                                <td class="text-uppercase"><?php echo $item->nama_kamp ?></td>
                                <td>
